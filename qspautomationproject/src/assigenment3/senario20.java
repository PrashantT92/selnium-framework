...
public class senario20 {
	...
	public static void main(String[] args) {
		 ...
		 driver.findElement(By.xpath("//span[.='10 gram'and(@data-p='l-gold-coins-weight-10gms,m')]")).click();
		 WebElement weight=driver.findElement(By.xpath("//span[.='(10 gram)']"));
	String ele = weight.getText();
	
	if(ele.equalsIgnoreCase("(10 gram)"))
	{
		 
	    
		 System.out.println("10gm coin is dispaly");
	}
	else
	{
